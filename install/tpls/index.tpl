...
<div class="license">
	...
	<p>版权所有 (c) 2001-2010，郑州知深教育咨询有限公司保留所有权利。</p>
	<p>感谢您选择 ABCMS 产品。希望我们的努力能为您提供一个高效快速和强大的站点解决方案。</p>
	<p>郑州知深教育咨询有限公司为 ABCMS 产品的开发商，依法独立拥有 ABCMS 产品著作权。ABCMS官方网址为 <a href="http://www.26856.com/">http://www.26856.com/</a>。</p>
	<p>ABCMS 著作权已在中华人民共和国国家版权局注册，著作权受到法律和国际公约保护。使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用 ABCMS 软件。</p>
	<p>本授权协议适用且仅适用于 ABCMS 0.x 版本，郑州知深教育咨询有限公司拥有对本授权协议的最终解释权。</p>

	<h3>I. 协议许可的权利</h3>
	<ol>
		<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
		<li>您可以在协议规定的约束和限制范围内修改 ABCMS 源代码(如果被提供的话)或界面风格以适应您的网站要求。</li>
	...
	<h3>II. 协议规定的约束和限制</h3>
	<ol>
		<li>未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆http://www.26856.com参考相关说明。</li>
		<li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
		<li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用 ABCMS 的整体或任何部分，未经书面许可，页面页脚处的 ABCMS 名称和郑州知深教育咨询有限公司下属网站（http://www.qihaolou.com、http://www.zzdxs.net 或 http://www.26856.com） 的链接都必须保留，而不能清除或修改。</li>
		<li>禁止在 ABCMS 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
	...
	<ol>
		...
		<li>郑州知深教育咨询有限公司不对使用本软件构建的网站中的文章或信息承担责任。</li>
	</ol>
