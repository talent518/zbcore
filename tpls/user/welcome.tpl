<div class="head">
	<a href="{link method=edit}" title="修改帐户" class="edit button fr" style="margin:-4px;">修改帐户</a>
...
<dl class="base">
	<dt><a id="editdatum" href="{link method=datum}" title="编辑个人资料" class="edit">编辑</a>{if $MEMBER.iscorp}公司资料{else}个人资料{/if}</dt>
	<dd>
	{if $MEMBER.iscorp}
